    ...
    if onto is not None and onto1 is not None:
        ...
        for i in onto_elements:
            try:
                ...
                pass
        #go through all elements and calculate the Levenshtein distance
                ...
                for j in onto1_elements:
                    ...
                    if label1 != None:
                        ...
                        if distance > 0 and distance < 5:
                            util.write2File("distances.txt", "Nodes " + i.name + "(" + label.get_text() + ")" + " and " + j.name + "(" + label1.get_text() + ")" + " have the Levenshtein distance: " + str(distance) + "\n", "a")